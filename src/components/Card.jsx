...
export default function Card(props) {
  return (
    <div className="group w-[30%] h-[30%] relative overflow-hidden gap-1 max-sm:w-36 max-sm:h-36">
      <img src={
        new URL(`../assets/img/${props.item.image}`,import.meta.url).href
      } alt="parfum" className='h-full w-full group-hover:scale-110 group-hover:transition group-hover:duration-[2s] group-hover:ease-in-out'/>
